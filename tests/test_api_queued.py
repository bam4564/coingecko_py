...
class TestWrapper(unittest.TestCase):
    ...
    @responses.activate
    def test_failed_ping_queued(self):
        # Arrange
    ...
    #---------- /simple/price ----------#
    @responses.activate
    def test_get_price_queued(self):
        # Arrange
        ...
        # Act
        self.cg.get_price('bitcoin', 'usd', qid=TEST_ID)
        assert len(self.cg._queued_calls) == 1
        response = self.cg.execute_queued()[TEST_ID]
    ...
    @responses.activate
    def test_failed_get_price_queued(self):
        # Arrange
        responses.add(responses.GET, 'https://api.coingecko.com/api/v3/simple/price?ids=bitcoin&vs_currencies=usd',
                          status = 404)
    ...
    @responses.activate
    def test_get_token_price_queued(self):
        # Arrange
        ...
        # Act
        self.cg.get_token_price('ethereum', '0xB8c77482e45F1F44dE1745F52C74426C631bDD52', 'bnb', include_market_cap='true', include_24hr_vol='true', include_last_updated_at='true', qid=TEST_ID)
        assert len(self.cg._queued_calls) == 1
        response = self.cg.execute_queued()[TEST_ID]
    ...
    @responses.activate
    def test_failed_get_token_price_queued(self):
        # Arrange
        responses.add(responses.GET, 'https://api.coingecko.com/api/v3/simple/token_price/ethereum?include_market_cap=true&include_24hr_vol=true&include_last_updated_at=true&contract_addresses=0xB8c77482e45F1F44dE1745F52C74426C631bDD52&vs_currencies=bnb',
                          status = 404)
    ...
    @responses.activate
    def test_get_supported_vs_currencies_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_failed_get_supported_vs_currencies_queued(self):
        # Arrange
        responses.add(responses.GET, 'https://api.coingecko.com/api/v3/simple/supported_vs_currencies',
                          status = 404)
    ...
    #---------- /price/coins ----------#
    @responses.activate
    def test_failed_get_coins_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_coins_queued(self):
        # Arrange
    ...
    #---------- /price/coins/list ----------#
    @responses.activate
    def test_failed_get_coins_list_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_coins_list_queued(self):
        # Arrange
    ...
    #---------- /price/coins/markets ----------#
    @responses.activate
    def test_failed_get_coins_markets_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_coins_markets_queued(self):
        # Arrange
    ...
    #---------- /price/coins/{id} ----------#
    @responses.activate
    def test_failed_get_coin_by_id_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_coin_by_id_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_failed_get_coin_ticker_by_id_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_get_coin_ticker_by_id_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_failed_get_coin_history_by_id_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_coin_history_by_id_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_failed_get_coin_market_chart_by_id_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_coin_market_chart_by_id_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_failed_get_coin_status_updates_by_id_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_coin_status_updates_by_id_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_failed_get_coin_info_from_contract_address_by_id_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_coin_info_from_contract_address_by_id_queued(self):
        # Arrange
    ...
    #---------- /exchanges ----------#
    @responses.activate
    def test_failed_get_exchanges_list_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_exchanges_list_queued(self):
        # Arrange
    ...
    #---------- /exchanges/list ----------#
    @responses.activate
    def test_failed_get_exchanges_id_name_list_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_exchanges_id_name_list_queued(self):
        # Arrange
    ...
    #---------- /exchanges/{id} ----------#
    @responses.activate
    def test_failed_get_exchanges_by_id_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_exchanges_by_id_queued(self):
        # Arrange
    ...
    #---------- /exchange_rates ----------#
    @responses.activate
    def test_failed_get_exchange_rates_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_exchange_rates_queued(self):
        # Arrange
    ...
    #---------- /search/trending ----------#
    @responses.activate
    def test_failed_search_get_trending_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_search_trending_queued(self):
        # Arrange
    ...
    #---------- /global ----------#
    @responses.activate
    def test_failed_get_global_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_global_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_failed_get_finance_platforms_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_finance_platforms_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_failed_get_finance_products_queued(self):
        # Arrange
    ...
    @responses.activate
    def test_get_finance_products_queued(self):
        # Arrange
        json_response = [{"name": "Binance Lending", "facts": "", "category": "", "centralized": False, "website_url": ""}, {"name": "Celsius Network", "facts": "", "category": "", "centralized": False, "website_url": ""}, {"name": "Compound Finance", "facts": "", "category": "", "centralized": False, "website_url": ""}, {"name": "dYdX", "facts": "", "category": "", "centralized": False, "website_url": ""}, {"name": "Nexo", "facts": "", "category": "", "centralized": False, "website_url": ""}, {"name": "Staked US", "facts": "", "category": "", "centralized": False, "website_url": "https://staked.us/"}, {"name": "Cobo", "facts": "", "category": "", "centralized": False, "website_url": "https://cobo.com/"}, {"name": "Crypto.com", "facts": "", "category": "", "centralized": True, "website_url": "https://crypto.com/en/"}]
    ...
    def test_multiple_rate_limited_success(self, sleep_patch):
        ...
        prices_json_response = { "prices": [ [ 1535373899623, 6756.942910425894 ], [ 1535374183927, 6696.894541693875 ], [ 1535374496401, 6689.990513793263 ], [ 1535374779118, 6668.291007556478 ], [ 1535375102688, 6703.7499879964 ], [ 1535375384209, 6706.898948451269 ] ] }
        history_json_response = { "id": "bitcoin", "symbol": "btc", "name": "Bitcoin", "localization": { "en": "Bitcoin", "es": "Bitcoin", "de": "Bitcoin", "nl": "Bitcoin", "pt": "Bitcoin", "fr": "Bitcoin", "it": "Bitcoin", "hu": "Bitcoin", "ro": "Bitcoin", "sv": "Bitcoin", "pl": "Bitcoin", "id": "Bitcoin", "zh": "比特币", "zh-tw": "比特幣", "ja": "ビットコイン", "ko": "비트코인", "ru": "биткоина", "ar": "بيتكوين", "th": "บิตคอยน์", "vi": "Bitcoin", "tr": "Bitcoin" } }
        ...
        responses.add_callback(
            responses.GET, 'https://api.coingecko.com/api/v3/coins/bitcoin/history?date=27-08-2018',
