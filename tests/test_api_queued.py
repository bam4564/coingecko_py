...
class TestWrapper(unittest.TestCase):
    ...
    def test_failed_get_coins_queued(self):
        # Arrange
        responses.add(
            responses.GET, "https://api.coingecko.com/api/v3/coins", status=404
        )
        ...
        coins_json_sample = [
            {
                ...
                "image": {
                    ...
                    "large": "https://assets.coingecko.com/coins/images/1/large/bitcoin.png?1510040391",
                },
            }
        ]
    ...
    def test_failed_get_coins_list_queued(self):
        # Arrange
        responses.add(
            responses.GET, "https://api.coingecko.com/api/v3/coins/list", status=404
        )
    ...
    def test_failed_get_coin_by_id_queued(self):
        # Arrange
        responses.add(
            responses.GET, "https://api.coingecko.com/api/v3/coins/bitcoin/", status=404
        )
    ...
    def test_failed_get_exchanges_list_queued(self):
        # Arrange
        responses.add(
            responses.GET, "https://api.coingecko.com/api/v3/exchanges", status=404
        )
    ...
    def test_failed_get_exchanges_id_name_list_queued(self):
        # Arrange
        responses.add(
            responses.GET, "https://api.coingecko.com/api/v3/exchanges/list", status=404
        )
    ...
    def test_failed_get_exchange_rates_queued(self):
        # Arrange
        responses.add(
            responses.GET, "https://api.coingecko.com/api/v3/exchange_rates", status=404
        )
    ...
    def test_failed_get_global_queued(self):
        # Arrange
        responses.add(
            responses.GET, "https://api.coingecko.com/api/v3/global", status=404
        )
    ...
    def test_get_finance_platforms_queued(self):
        ...
        json_response = [
            ...
            },
            {
                ...
                "category": "",
                "centralized": True,
                "website_url": "https://crypto.com/en/",
            },
        ]
